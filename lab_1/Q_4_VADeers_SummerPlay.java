...
public class Q_4_VADeers_SummerPlay {

	public static void main(String[] args) {
		/*Question-4

The deers in VA spend most of the day playing. In particular, 
they play if the temperature is between 60 and 90. Unless it is summer, 
...
deerPlay(95, true); - > true  */
	...
	public static void vaDeers( double tem, boolean isSummer) {
